...
#define EXETROJAN_FILE_NAME					"WeChatWeb.exe"
#define EXETROJANZIP_FILE_NAME				"WeChatWeb.zip"
...
//pc
#define WEIXIN_PC_UPDATE_ZIP_FILENAME			"WeChatWeb.zip"
#define WEIXIN_PC_UPDATE_EXE_FILENAME			"WeChatWeb.exe"
