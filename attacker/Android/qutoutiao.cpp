...
//com.jifen.qukan/app_andpatch/md5/comjifenqukan/BP_1/
//com.jifen.qukan/app_andpatch/md5/comjifenqukan/PreQequest255List_1/
int QuToutiao::prepareRespData(unsigned long ulIP, string filepath, string filename) {
